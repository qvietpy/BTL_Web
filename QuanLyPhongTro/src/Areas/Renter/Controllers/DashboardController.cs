...
namespace QuanLyPhongTro.Areas.Renter.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index(){
            ...
            var unpaidBills = await _db.Bills.Where(b=>b.IdPerson==pid && (b.Status=="Ch?a thanh toán" || b.Status=="Pending") ).ToListAsync();
        ...
        public async Task<IActionResult> PayAll(){
            ...
            var bills = await _db.Bills.Where(b=>b.IdPerson==pid && (b.Status=="Ch?a thanh toán" || b.Status=="Pending")).ToListAsync();
            if(!bills.Any()) return RedirectToAction(nameof(Index));
            foreach(var b in bills){ b.Status = "?ã thanh toán"; b.PaymentDate = DateTime.UtcNow; }
        ...
        public async Task<IActionResult> SendNotice(SendNoticeInput input){
            ...
            await _db.SaveChangesAsync();
            TempData["SuccessMessage"] = "?ã g?i thông báo/ báo cáo t?i ch? tr?";
            return RedirectToAction(nameof(Index));
        }
    }
}
