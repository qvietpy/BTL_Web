...
namespace QuanLyPhongTro.Areas.Owner.Controllers
{
    ...
    public class ContractsController : Controller
    {
        ...
        public async Task<IActionResult> ApproveExtension(Guid id){
            ...
            if(c==null){ TempData["ErrorMessage"]="Không tìm th?y h?p ??ng"; return RedirectToAction(nameof(Index)); }
            if(!(c.ExtensionStatus?.Equals("Pending", StringComparison.OrdinalIgnoreCase) ?? false) || c.RequestedExtensionMonths==null){ TempData["ErrorMessage"]="Không có yêu c?u gia h?n"; return RedirectToAction(nameof(Index)); }
            ...
            TempData["SuccessMessage"]="?ã duy?t gia h?n h?p ??ng";
        ...
        public async Task<IActionResult> RejectExtension(Guid id){
            ...
            await _db.SaveChangesAsync();
            TempData["SuccessMessage"]="?ã t? ch?i yêu c?u gia h?n";
            return RedirectToAction(nameof(Index));
        }
    }
}
